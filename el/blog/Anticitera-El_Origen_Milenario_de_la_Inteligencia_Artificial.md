...
1. Ο Μηχανισμός των Αντικυθήρων: Μια Μηχανή Πέρα από την Εποχή της [#](#1-o-mixanismos-ton-antikythiron-mia-mixani-pera-apo-tin-epoxi-tis)
...
2. Ποια είναι η Σχέση του με την ΤΝ; [#](#2-poia-einai-i-sxesi-toy-me-tin-tn)


Αν και ο Μηχανισμός των Αντικυθήρων δεν είναι τεχνητή νοημοσύνη με τη σημερινή έννοια, μοιράζεται μαζί της βασικές αρχές:


🔵 Αυτοματοποίηση της Γνώσης [#](#aytomatopoiisi-tis-gnosis)
...
🔵 Πρώιμη Αλγοριθμική Μηχανική [#](#proimi-algorithmiki-mixaniki)
...
🔵 Ένα Σύστημα Λήψης Αποφάσεων Βασισμένο σε Δεδομένα [#](#ena-systima-lipsis-apofaseon-basismeno-se-dedomena)
...
3. Από το Παρελθόν στο Μέλλον: Η Κληρονομιά των Αντικυθήρων στη Σύγχρονη ΤΝ [#](#3-apo-to-parelthon-sto-mellon-i-klironomia-ton-antikythiron-sti-sygxroni-tn)
...
![Εικονογράφηση μιας αρχαίας ελληνικής γαλέρας που πλέει σε μια θυελλώδη θάλασσα](https://anticitera.deft.work/img/Gemini_Galera.webp)
