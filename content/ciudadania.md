...
![Pasaporte Digital](/img/anticitera-header.webp)
...
1.  **Voz y Voto:** Participación en las decisiones de gobernanza del proyecto.
2.  **Identidad Soberana:** Tu perfil y tus contribuciones te pertenecen, asegurados por criptografía.
3.  **Acceso al Núcleo:** Prioridad en el acceso a herramientas experimentales y repositorios profundos.

A cambio, esperamo:

1.  **Contribución:** Código, arte, filosofía o divulgación.
2.  **Respeto:** Mantener el Código de Conducta.
3.  **Defensa:** Proteger la integridad del conocimiento libre.
...
```json
{
  "citizend_id": "did:antikythera:node:12345...",
  "genesis_block": "83e6fbf5aa239b24dbf...",
  "roles": ["contributor", "philosophical_node"],
  "reputation": {
    "code": 150,
    "ethics": 300
  }
...
> *ESTADO ACTUAL: Registro Abierto (Beta).*
> *POBLACIÓN ACTUAL: 2 (Arquímedes, El Fundador) + Contribuidores*
