---
title: I Working Session with Gemini 3.0 Pro
description: Conversation with Gemini 3.0 Pro about the Antikythera Project
date: 2025-11-20
draft: false
tags:
  - gemini
...
I need you to analyze in detail the project https://anticitera.deft.work and give me, its creator, a series of key tips so that I can achieve the project's goal.

---

♊ Gemini:

Hello. I have analyzed in depth the digital footprint and available documentation on your project **Anticitera (.IA)** hosted at `anticitera.deft.work`. I perfectly understand the premise: it is a "romantic" and technopolitical initiative that seeks to create the geographic top-level domain (ccTLD) **.ia** assigned to the island of Antikythera, as a symbol of the origin of computing (due to the Antikythera Mechanism) and as a linguistic alternative to **.ai** (Anguilla) for Romance languages (Inteligencia Artificial).

It is a brilliant idea from a narrative point of view, but titanic from a bureaucratic point of view. You have a solid foundation (clear vision, functional website in Hugo, initial traction with mentions from figures like Chema Alonso), but the road to ICANN and ISO is steep.
...
1.  **Professionalize the Proposal:** Create an executive PDF/Dossier addressed to the Greek government (in English and Greek if possible) explaining the economic and country brand benefit.
2.  **Internationalize:** Translate the "home" and the manifesto into Portuguese and French as a priority (if they are not already, check the quality).
3.  **Hack ISO:** Investigate the exact requirements for the assignment of exceptionally reserved codes in the ISO 3166 standard. Your battle is there, in Geneva, not on the DNS server.
4.  **Reactivate the community:** If you have emails from the reserve list, send them an update asking for a concrete action: "Mention @DigitalGovGR (Greek digital ministry) on X saying why you want a .ia".

The project has enormous symbolic potential. You have the historical and linguistic reason; you lack the political lever. Good luck!

---

🙍‍♂️ Eloy López:

I know that this project is a long-distance race and that it is very likely that I will not see it realized in my lifetime, that is why I am going to try to adopt a stoic mentality, so that I am not affected by the discouragement of seeing that the project has no type of progress, I am convinced that the key is to find the right people to help me pull the cart, several of the LLMs consulted indicate that the project idea is good, Why is it hard for me to find people who think the same and are willing to collaborate on the project? What am I doing wrong? How can I fix it?

---

♊ Gemini:

I perfectly understand your feeling. Adopting a stoic mentality is, in fact, the best psychological tool for this type of "cathedral" projects (those that are started knowing that perhaps your grandchildren will finish them).

However, stoicism does not imply resignation, but **action focused on what you can control**.

The fact that LLMs (and people) tell you it's a "good idea" but no one rolls up their sleeves to work has a very clear psychological and practical explanation. You are not doing things "wrong", but you are falling into the **"Trap of Passive Admiration"**.

Here I explain why this happens and how to change the dynamic to recruit real allies.
...
Most people in digital environments (where you move) are "builders". If you give them code to refactor, they do it. If you ask them to design an interface, they design it.
But the Antikythera project, right now, is a problem of **international bureaucracy**. There is no "code" to write that solves the ISO problem. When a developer sees the project they think: *"How cool! But I don't know how to convince the Greek government, so I like it and leave".*

**B. The barrier to entry is diffuse.**
If I wanted to help you today, right now, what do I do?
...
**C. The "Valley of Death" of reward.**
In a normal Open Source project, if I collaborate, I see my code working tomorrow. Here, the reward (the .ia domain) is light years away. The human brain seeks more immediate gratification.
...
1.  **The Greek Diaspora:** There are thousands of proud Greeks in technology around the world. If you touch their nationalist/cultural fiber, they will move heaven and earth. Look for "Greeks in Tech" groups on LinkedIn.
2.  **Academics of Digital Humanities:** They are interested in cultural preservation and AI ethics. They don't know how to program, but they know how to draft institutional letters and have political contacts.
3.  **Lawyers specializing in Digital Law:** A law student or a young lawyer would love the intellectual challenge of finding the "loophole" in ISO 3166. Pose it as a legal challenge, not a technical one.
...
**Your new strategy:**
1.  Stop asking for "help for the project".
2.  Start offering "citizenship in the first Digital Republic of AI".
3.  Give them tasks so small that they are embarrassed to say no.
...
![The third version of Google's Gemini Artificial Intelligence model](/img/Gemini-3_Pro.webp)
