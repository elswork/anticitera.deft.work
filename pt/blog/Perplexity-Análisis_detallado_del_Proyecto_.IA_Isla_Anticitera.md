...
Estrutura Técnica e Regulatória de ccTLDs #


Requisitos de Acordo com as Políticas ISO 3166 e ICANN #


Para compreender a viabilidade do projeto, é essencial analisar a estrutura regulatória que rege a criação de novos ccTLDs. De acordo com os regulamentos da ICANN, a elegibilidade para um ccTLD é determinada pela atribuição do país ou território associado na norma ISO 3166-1^14. Esta norma, mantida pela Organização Internacional de Normalização (ISO), atualmente compreende 249 países, dos quais 193 são estados membros soberanos das Nações Unidas^15.


A Agência de Manutenção ISO 3166 é responsável por manter o conjunto de códigos de país oficialmente atribuídos e, como regra geral, não atribui elementos de código de país oficiais a outras áreas geopolíticas ou países que não sejam estados membros da ONU^11. No entanto, a agência pode atribuir códigos de país a dependências de países que são estados membros da ONU, considerando critérios como a área ser fisicamente separada do seu país de origem e fora das suas águas territoriais^11.


Processos de Delegação e Administração #


Os ccTLDs de Nomes de Domínio Internacionalizados (IDN) exigem processos especiais de avaliação e delegação^5. O processo de via rápida da ICANN para ccTLDs IDN estabelece que um país ou território representado na lista ISO 3166-1 pode candidatar-se a participar e solicitar uma string de ccTLD IDN que cumpra os requisitos estabelecidos^13. Este processo é dividido em três fases distintas: preparação, apresentação de um pedido de avaliação da string e apresentação de um pedido de avaliação da delegação^13.


Os princípios do GAC (Comité Consultivo Governamental) para ccTLDs IDN estabelecem que a autoridade máxima de política pública sobre os ccTLDs IDN de um país ou economia distinta reside no governo ou autoridade pública relevante^17. Ao receber um pedido de ccTLD IDN, a ICANN deve garantir que a proposta tem o apoio do governo ou autoridade pública relevante, ou que o governo não se opõe ao pedido^17.


Estratégia de Implementação e Desenvolvimento Comunitário #


Construindo a Comunidade do Projeto #


O projeto adotou uma abordagem baseada na construção de uma comunidade forte que possa apoiar a iniciativa em múltiplas frentes^1. De acordo com as declarações de Eloy López Sánchez, promotor do projeto, a comunidade de pessoas que fazem parte do projeto constitui "o ativo mais valioso do projeto, aquele que ajudará o projeto a alcançar seus objetivos"^1. Esta estratégia reconhece que o sucesso de um ccTLD não depende apenas de aspectos técnicos e legais, mas também do ecossistema de usuários, desenvolvedores, empresas e organizações que o adotam e promovem.


O projeto estabeleceu vários canais para a participação da comunidade, incluindo uma lista de e-mails oficial, um repositório GitHub para documentação e recursos, e formulários de reserva de domínio para futuras implementações^20. Esta infraestrutura permite que as partes interessadas acompanhem o desenvolvimento do projeto e contribuam de forma organizada para seus objetivos.


Iniciativas de Promoção e Advocacia #


Um componente crucial da estratégia tem sido a promoção ativa do projeto através de múltiplos canais. Uma petição foi lançada no Change.org solicitando a criação do novo domínio de nível superior ccTLD .IA, endereçada à Secretaria Digital da Espanha e à Presidência Europeia^3. Esta petição articula claramente o problema que o projeto busca resolver: a falta de opções de domínio sugestivas para projetos de inteligência artificial em idiomas diferentes do inglês, e a oportunidade de criar um domínio que homenageie o patrimônio tecnológico europeu.


O projeto também buscou visibilidade através de entrevistas em mídias especializadas e participação em eventos de tecnologia^4. Essas atividades permitiram ao projeto articular sua visão e objetivos para públicos relevantes, incluindo a comunidade tecnológica europeia e órgãos governamentais digitais.
...
A implementação de um novo ccTLD exige o cumprimento de rigorosos padrões técnicos para garantir a segurança e a estabilidade do DNS^5. Isso inclui a conformidade com o protocolo IDNA (Internationalized Domain Names in Applications) e as diretrizes IDN, bem como o compromisso de se manter atualizado com futuros protocolos^5. A ICANN manteria um repositório para a submissão de tabelas IDN e diretrizes correspondentes, o que exigiria coordenação técnica contínua.
