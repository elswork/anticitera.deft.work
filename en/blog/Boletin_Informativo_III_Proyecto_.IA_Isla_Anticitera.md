...
Eloy López's Introduction [#](#eloy-lopez-s-introduction)
...
What achievements can we highlight in this time? [#](#what-achievements-can-we-highlight-in-this-time)
...
Proposal to the community [#](#proposal-to-the-community)
...
[![A red backlit computer keyboard, with a world map in the background showing interconnected colored nodes.](https://anticitera.deft.work/img/TecladoyPaises.webp)](https://anticitera.deft.work)
