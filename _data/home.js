module.exports = {
  ...
  ru: {
    ...
    paragraph1: "Проект .IA Остров Антикитера — это инициатива по созданию нового домена верхнего уровня с кодом страны (ccTLD) .IA, связанного с территорией острова Антикитера. Этот небольшой остров, известный благодаря Антикитерскому механизму, который считается первым аналоговым компьютером в истории, становится символом истоков искусственного интеллекта и технологических инноваций.",
    paragraph2: "Проект .IA Остров Антикитера — это также сообщество людей, которые так или иначе являются частью проекта. Это самый ценный актив проекта, который поможет проекту достичь своих целей.",
    link: {
      text: "Что такое проект .IA Остров Антикитера?",
      url: "/ru/blog/Que_es_el_Proyecto_.IA_Isla_Anticitera/"
    },
    messageBox: {
      item1: "Существует ccTLD .AI, обычно используемый для проектов «Искусственного интеллекта», но не существует ccTLD .IA, который представлял бы большинство остальных языков планеты.",
      item2: "Мы стремимся создать сообщество энтузиастов ИИ для продвижения создания домена верхнего уровня ccTLD .IA на исторической территории острова Антикитера.",
      item3: "Ознакомьтесь с деталями <a href=\"/ru/about\">Проекта</a>.",
      footer: "Это база знаний для <a href=\"https://chat.openai.com/g/g-fnpHOClUW-anticitera\">Ассистента Антикитера от OpenAI</a>, созданного для помощи в создании технологических проектов, связанных с .IA"
    },
    buttons: {
      edit_github: "Редактировать на",
      vote_change_org: "Подписать на",
      telegram_group: "Войти в",
      suscribe_mail_list: "Подписаться на",
